...
using PDS.SpaceBE.BAT.PADS.Module.Aggregations;
using PDS.SpaceBE.BAT.PADS.Module.Data.PADSModel;
using System.Collections.Generic;
using Moq;

namespace PDS.SpaceBE.BAT.PADS.Module.Tests.Aggregations
{
    /// <summary>
    ...
    public class LotAggregationTest
    {
        ...
        public void TestCreateNew()
        {
            ...
            Assert.AreEqual("Measlot::SPACEAGGED2:BAT:BE:BE1I:A2_Plating::ProcessControl:1.0", newLotPads.SearchPatterns.SpaceKey);
        }
