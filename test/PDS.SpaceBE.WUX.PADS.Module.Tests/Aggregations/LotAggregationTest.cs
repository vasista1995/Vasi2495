...
namespace PDS.SpaceBE.WUX.PADS.Module.Tests.Aggregations
{
    /// <summary>
    ...
    public class LotAggregationTest
    {
        ...
        public void TestCreateNew()
        {
            ...
            Assert.AreEqual("Measlot:PF328438C01:SPACEAGGED2:WUX:BE:ACWUS:P_BeforeMTF_Visual_Inspection::ProcessControl:1.0", newLotPads.SearchPatterns.SpaceKey);
        }
