...
namespace PDS.SpaceBE.RBG.Source.Module.Tests
{
    [TestClass]
    public class SpaceE4AConverterTest
    {
        ...
        public void TestConvert()
        {
            ...
            var spaceEntry = JsonUtils.FromJson<SpaceEntry>(Properties.Resources.SourceRecord);
            ...
            var expectedJson = JToken.Parse(Properties.Resources.ExpectedE4a);
        ...
        public void TestGetSourceDataLevel()
        {
            ...
            Assert.AreEqual("W", SpaceE4AConverter.GetSourceDataLevel("LT8C", "N", ""));
