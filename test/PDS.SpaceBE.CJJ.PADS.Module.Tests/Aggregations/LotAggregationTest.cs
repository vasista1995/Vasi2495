...
using PDS.SpaceBE.CJJ.PADS.Module.Aggregations;
using PDS.SpaceBE.CJJ.PADS.Module.Data.PADSModel;
using System.Collections.Generic;
using Moq;

namespace PDS.SpaceBE.CJJ.PADS.Module.Tests.Aggregations
{
    /// <summary>
    ...
    public class LotAggregationTest
    {
        ...
        public void TestCreateNew()
        {
            ...
            Assert.AreEqual("Measlot:2Z34902B:SPACEAGGED2:CJJ:BE::::ProcessControl:1.0", newLotPads.SearchPatterns.SpaceKey);
        }
