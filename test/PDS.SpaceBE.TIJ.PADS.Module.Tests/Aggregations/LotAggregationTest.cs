...
using PDS.SpaceBE.TIJ.PADS.Module.Aggregations;
using PDS.SpaceBE.TIJ.PADS.Module.Data.PADSModel;
using System.Collections.Generic;
using Moq;

namespace PDS.SpaceBE.TIJ.PADS.Module.Tests.Aggregations
{
    /// <summary>
    ...
    public class LotAggregationTest
    {
        ...
        [TestMethod]
        public void TestCheckExisitingRawValuesTrue()
        {
        ...
        [TestMethod]
        public void TestCheckExisitingRawValuesFalse()
        {
        ...
        public void TestCreateNew()
        {
            ...
            Assert.AreEqual("Measlot:104OLWB.I01:SPACEAGGED2:TIJ:BE:Plastic_Singulacion:Assy_EOL:ProcessControl:1.0", newLotPads.SearchPatterns.SpaceKey);
        }
        ...
        public void TestUpdateNewParamRvStoreFalse()
        {
            ...
            var aggregation = new LotAggregation(spaceE4A, new Mock<IQueueMessage>().Object);
            var newLotPads = aggregation.UpdateExisting(checkDoc);
            Assert.AreEqual("Measlot:104OMCQ.I01:SPACEAGGED2:TIJ:BE:Plastic_Singulacion:Assy_EOL:ProcessControl:1.0", newLotPads.SearchPatterns.SpaceKey);
        }
