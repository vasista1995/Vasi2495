...
{
    /// <summary>
    /// This class creates a kafka producer, a connection to space TIJ fe offline database.
    ...
    {
        private const string DefaultLoadingJob = "TIJ";
        private readonly string _regressionTestsDirectoryPath = @"..\..\..\..\..\test\PDS.SpaceBE.TIJ.Source.Module.Tests\Resources\RegressionTests\";
