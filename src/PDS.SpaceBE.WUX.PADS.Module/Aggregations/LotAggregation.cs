...
namespace PDS.SpaceBE.WUX.PADS.Module.Aggregations
{
    /// <summary>
    ...
    public class LotAggregation : BaseAggregation
    {
        ...
        private static DataFlatMetaDataPads CreateDataFlatMetaData(SpaceE4A e4aDocument)
        {
            ...
            dataFlatMetaData.GaugeID = e4aMetaData.GaugeID;
        ...
        private static List<Data1ListRawValuesPads> CreateData1listRawValuesList(SpaceE4A e4aDocument)
        {
            ...
            {
                list.Add(CreateData1ListRawValues(rawValues, e4aDocument));
            }
            return list;
        }
        ...
        /// <param name="e4aDocument"></param>
        /// <returns></returns>
        internal static Data1ListRawValuesPads CreateData1ListRawValues(Data1ListRawValuesE4A e4aRawValues, SpaceE4A e4aDocument)
        {
            ...
            rawValues.Wafer = e4aRawValues.Wafer;
            return rawValues;
        }
        ...
        private static StrangeDataFlatMetaDataPads UpdateDataFlatStrangeMetaData(SpaceE4A e4adocument, SpacePads checkdocument)
        {
            ...
            dataFlatStrangeMetaData.Wire = SpaceAggregationUtils.JoinStrings(e4aMetaData.Wire, checkMetaData.Wire);
            dataFlatStrangeMetaData.Owner = SpaceAggregationUtils.JoinStrings(e4aMetaData.Owner, checkMetaData.Owner);
        ...
        private static DataFlatMetaDataPads UpdateDataFlatMetaData(SpaceE4A e4adocument, SpacePads checkdocument)
        {
            ...
            dataFlatMetaData.GaugeID = SpaceAggregationUtils.JoinStrings(checkMetaData.GaugeID, e4aMetaData.GaugeID);
            dataFlatMetaData.Line = SpaceAggregationUtils.JoinStrings(checkMetaData.Line, e4aMetaData.Line);
        ...
        private static string GetLotAggregationId(SpaceE4A e4aEntry)
        {
            ...
            return $"{id}:SPACEAGGED2:WUX:BE:{facility}:{oper}:{specName}:ProcessControl:1.0";
        }
        ...
        private static string GetProductionActionId(SpaceE4A e4aEntry)
        {
            ...
            string specName = "";
            string oper = e4aEntry.DataFlatMetaData.ParameterOper;
            return $"SPACEAGGED2:WUX:BE:{facility}:{oper}:{specName}";
        }
    }
}
