...
using PDS.SpaceBE.CEG.Source.Module.Data;
...
namespace PDS.SpaceBE.CEG.Source.Module
{
    ...
    {
        private const string DefaultLoadingJob = "CEG";
        private readonly string _regressionTestsDirectoryPath = @"..\..\..\..\..\test\PDS.SpaceBE.CEG.Source.Module.Tests\Resources\RegressionTests\";
