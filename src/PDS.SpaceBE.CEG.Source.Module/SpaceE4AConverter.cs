...
namespace PDS.SpaceBE.CEG.Source.Module
{
    /// <summary>
    ...
    public static class SpaceE4AConverter
    {
        ...
        private static DataFlatMetaDataE4A CreateFlatMetaData(SpaceEntry entry, string sourceDataLevel)
        {
            ...
            e4a.MaterialNumber = entry.MaterialNumber;
            ...
            e4a.PosName = entry.PosName;
            e4a.OCAPEquipment = entry.OCAPEquipment;
            ...
            // For Cegled Backened there is no BasicType information available.
        ...
        private static ItemE4A CreateItem(SpaceEntry entry)
        {
            return new ItemE4A()
            {
                Id = $"{entry.IdSystemName}:{entry.ProductionOrder}",
