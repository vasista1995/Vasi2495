...
namespace PDS.SpaceFE.RBG.Source.Module.Data
{
    ...
    public class SpaceDao
    {
        ...
        public IEnumerable<SpaceEntry> GetSpaceDatabaseEntries(DateTime startTime, DateTime endTime)
        {
            using (var conn = _databaseManager.OpenConnection(_connectionString))
            {
                ...
                return conn.Query<SpaceEntry, SpaceRawValuesEntry,SpaceEntry>(Properties.Resources.SpaceSqlQuery, (main, ravalues) =>
                {
                    ...
                    spaceEntry.SpaceRawValues.Add(ravalues);
                    return spaceEntry;
