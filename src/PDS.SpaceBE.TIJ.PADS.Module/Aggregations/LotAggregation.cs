...
namespace PDS.SpaceBE.TIJ.PADS.Module.Aggregations
{
    /// <summary>
    ...
    public class LotAggregation : BaseAggregation
    {
        ...
        private static DataFlatMetaDataPads CreateDataFlatMetaData(SpaceE4A e4aDocument)
        {
            ...
            // Only for TIJ site
            dataFlatMetaData.HexSize = e4aMetaData.HexSize;
            dataFlatMetaData.Layout = e4aMetaData.Layout;
            dataFlatMetaData.LeadFormCategory = e4aMetaData.LeadFormCategory;
            dataFlatMetaData.MoldCompound = e4aMetaData.MoldCompound;
            dataFlatMetaData.PartNumber = e4aMetaData.PartNumber;
            dataFlatMetaData.ProductionVersion = e4aMetaData.ProductionVersion;
            dataFlatMetaData.SolderType = e4aMetaData.SolderType;
            dataFlatMetaData.Track = e4aMetaData.Track;

            dataFlatMetaData.Equipment = e4aMetaData.Tool;
            dataFlatMetaData.Area = e4aMetaData.Area;
        ...
        private static List<Data1ListPads> CreateData1list(SpaceE4A e4aDocument)
        {
            ...
            data1List.PackageCF = e4aMetaData.PackageCF;
        ...
        internal static Data1ListRawValuesPads CreatData1ListRawValues(Data1ListRawValuesE4A e4aRawValues, SpaceE4A e4aDocument)
        {
            ...
            rawValues.ProcessEquipment = dataFlatMetaData.ProcessEquipment;
            return rawValues;
        }
        /// <summary>
        ...
        private static Data1ListPads UpdateOldData1list(SpaceE4A e4adocument, Data1ListPads checkDataList)
        {
            ...
            data1List.PackageCF = SpaceAggregationUtils.JoinStrings(e4aMetaData.PackageCF, checkDataList.PackageCF);
        ...
        private static DataFlatMetaDataPads UpdateDataFlatMetaData(SpaceE4A e4adocument, SpacePads checkdocument)
        {
            ...
            // Only for TIJ site
            dataFlatMetaData.HexSize = SpaceAggregationUtils.JoinStrings(checkMetaData.HexSize, e4aMetaData.HexSize);
            dataFlatMetaData.Layout = SpaceAggregationUtils.JoinStrings(checkMetaData.Layout, e4aMetaData.Layout);
            dataFlatMetaData.LeadFormCategory = SpaceAggregationUtils.JoinStrings(checkMetaData.LeadFormCategory, e4aMetaData.LeadFormCategory);
            dataFlatMetaData.MoldCompound = SpaceAggregationUtils.JoinStrings(checkMetaData.MoldCompound, e4aMetaData.MoldCompound);
            dataFlatMetaData.PartNumber = SpaceAggregationUtils.JoinStrings(checkMetaData.PartNumber, e4aMetaData.PartNumber);
            dataFlatMetaData.ProductionVersion = SpaceAggregationUtils.JoinStrings(checkMetaData.ProductionVersion, e4aMetaData.ProductionVersion);
            dataFlatMetaData.SolderType = SpaceAggregationUtils.JoinStrings(checkMetaData.SolderType, e4aMetaData.SolderType);
            dataFlatMetaData.Track = SpaceAggregationUtils.JoinStrings(checkMetaData.Track, e4aMetaData.Track);
            dataFlatMetaData.Equipment = e4aMetaData.Tool;
            dataFlatMetaData.Area = e4aMetaData.Area;
        ...
        private static string GetLotAggregationId(SpaceE4A e4aEntry)
        {
            ...
            string area = e4aEntry.DataFlatMetaData.Area;
            string module = e4aEntry.DataFlatMetaData.Module;
            return $"{id}:SPACEAGGED2:TIJ:BE:{area}:{module}:ProcessControl:1.0";
        }
        ...
        private static string GetProductionActionId(SpaceE4A e4aEntry)
        {
            string area = e4aEntry.DataFlatMetaData.Area;
            string module = e4aEntry.DataFlatMetaData.Module;
            return $"SPACEAGGED2:TIJ:BE:{area}:{module}";
        }
    }
}
