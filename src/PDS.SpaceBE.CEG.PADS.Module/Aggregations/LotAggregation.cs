...
namespace PDS.SpaceBE.CEG.PADS.Module.Aggregations
{
    /// <summary>
    ...
    public class LotAggregation : BaseAggregation
    {
        ...
        private static StrangeDataFlatMetaDataPads CreateStrangeMetaData(SpaceE4A e4adocument)
        {
            ...
            dataFlatStrangeMetaData.Length = e4aMetaData.Length;
            ...
            dataFlatStrangeMetaData.OCAPEquipment = e4aMetaData.OCAPEquipment;
            dataFlatStrangeMetaData.Published = e4aMetaData.Published;
            dataFlatStrangeMetaData.PosName = e4aMetaData.PosName;
        ...
        private static StrangeDataFlatMetaDataPads UpdateDataFlatStrangeMetaData(SpaceE4A e4adocument, SpacePads checkdocument)
        {
            ...
            dataFlatStrangeMetaData.Length = SpaceAggregationUtils.JoinStrings(e4aMetaData.Length, checkMetaData.Length);
            ...
            dataFlatStrangeMetaData.PosName = SpaceAggregationUtils.JoinStrings(e4aMetaData.PosName, checkMetaData.PosName);
            dataFlatStrangeMetaData.OCAPEquipment = SpaceAggregationUtils.JoinStrings(e4aMetaData.OCAPEquipment, checkMetaData.OCAPEquipment);
        ...
        private static List<Data1ListRawValuesPads> UpdateData1ListRawValuesPADS(SpaceE4A e4adocument, Data1ListPads checkdocument)
        {
            ...
            var e4aMetaData = e4adocument.DataFlatMetaData;
            long e4aRawSampleId = e4adocument.Data1List.Data1ListRawValues.Select(x => x.SampleId).FirstOrDefault();
        ...
        private static string GetLotAggregationId(SpaceE4A e4aEntry)
        {
            ...
            // At the moment Cegled's SPACE data does not provide any subOper information.
            // This may change in the future.
            string subOper = "";
            
            return $"{id}:SPACEAGGED3:CEG:BE:{line}:{oper}:{subOper}:ProcessControl:1.0";
        }
        ...
        private static string GetProductionActionId(SpaceE4A e4aEntry)
        {
            ...
            return $"SPACEAGGED3:CEG:BE:{line}:{oper}:{subOper}";
        }
    }
}
