...
using PDS.SpaceBE.BAT.Source.Module.Data;
...
using PDS.SpaceBE.BAT.Common.Config;
...
namespace PDS.SpaceBE.BAT.Source.Module
{
    ...
    {
        private const string DefaultLoadingJob = "BAT";
        private readonly string _regressionTestsDirectoryPath = @"..\..\..\..\..\test\PDS.SpaceBE.BAT.Source.Module.Tests\Resources\RegressionTests\";
